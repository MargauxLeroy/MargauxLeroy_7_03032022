import { getData, appData, getFilteredRecipes, getAllIngredients } from './utils/get-data.js';
...
const onAppUpdate = () => {
    ...
    const ingredients = getAllIngredients(recipes, appData.ingredient.searchValue);
    renderSelectSection(appData.ingredient.isSelectOpen, appData.ingredient.tags, ingredients);
