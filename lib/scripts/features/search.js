...
import { initSelectsEvents } from './select.js';

// const noRecipeText = document.querySelector('.no-recipe');
const searchInput = document.getElementById('search-input');
let currentRecipes = [];

export const updateCurrentRecipes = (newRecipes) => {
    currentRecipes = [...newRecipes];
};

export const getCurrentRecipe = () => currentRecipes;
